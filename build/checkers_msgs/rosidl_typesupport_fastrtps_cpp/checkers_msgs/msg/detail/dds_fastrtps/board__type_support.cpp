...
#include "checkers_msgs/msg/detail/board__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const checkers_msgs::msg::Board & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  checkers_msgs::msg::Board & ros_message)
{
  // Member: pieces
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = checkers_msgs::msg::Board;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const checkers_msgs::msg::Board *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<checkers_msgs::msg::Board *>(
    untyped_ros_message);
...
{
  return &checkers_msgs::msg::typesupport_fastrtps_cpp::_Board__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, checkers_msgs, msg, Board)() {
  return &checkers_msgs::msg::typesupport_fastrtps_cpp::_Board__handle;
}
