...
#include "checkers_msgs/msg/detail/piece__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const checkers_msgs::msg::Piece & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  checkers_msgs::msg::Piece & ros_message)
{
  // Member: row
  cdr >> ros_message.row;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = checkers_msgs::msg::Piece;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const checkers_msgs::msg::Piece *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<checkers_msgs::msg::Piece *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Piece__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const checkers_msgs::msg::Piece *>(
...
static size_t _Piece__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Piece(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Piece__callbacks = {
  "checkers_msgs::msg",
  "Piece",
...
static rosidl_message_type_support_t _Piece__handle = {
...
{
  return &checkers_msgs::msg::typesupport_fastrtps_cpp::_Piece__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, checkers_msgs, msg, Piece)() {
  return &checkers_msgs::msg::typesupport_fastrtps_cpp::_Piece__handle;
}
