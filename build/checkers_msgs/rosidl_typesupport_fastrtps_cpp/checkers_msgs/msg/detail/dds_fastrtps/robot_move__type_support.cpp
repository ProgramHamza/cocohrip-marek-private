...
#include "checkers_msgs/msg/detail/robot_move__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = checkers_msgs::msg::RobotMove;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const checkers_msgs::msg::RobotMove *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<checkers_msgs::msg::RobotMove *>(
    untyped_ros_message);
...
static size_t _RobotMove__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotMove(full_bounded, is_plain, 0);
...
{
  return &checkers_msgs::msg::typesupport_fastrtps_cpp::_RobotMove__handle;
}
