...
static const _Board_type_support_symbol_names_t _Board_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, checkers_msgs, msg, Board)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, checkers_msgs, msg, Board)),
  }
};
...
{
  return &::checkers_msgs::msg::rosidl_typesupport_cpp::Board_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, checkers_msgs, msg, Board)() {
  return get_message_type_support_handle<checkers_msgs::msg::Board>();
}
