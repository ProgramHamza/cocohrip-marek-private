...
class RobotMove(metaclass=Metaclass_RobotMove):
    ...
    def __init__(self, **kwargs):
        ...
        self.robot_move_done = kwargs.get('robot_move_done', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.robot_move_done != other.robot_move_done:
            return False
        return True
    ...
    @builtins.property
    def robot_move_done(self):
        """Message field 'robot_move_done'."""
        return self._robot_move_done

    @robot_move_done.setter
    def robot_move_done(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'robot_move_done' field must be of type 'bool'"
        self._robot_move_done = value
