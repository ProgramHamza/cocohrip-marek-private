...
bool checkers_msgs__msg__board__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("checkers_msgs.msg._board.Board", full_classname_dest, 30) == 0);
  }
  checkers_msgs__msg__Board * ros_message = _ros_message;
  {  // pieces
    ...
    checkers_msgs__msg__Piece * dest = ros_message->pieces.data;
...
PyObject * checkers_msgs__msg__board__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("checkers_msgs.msg._board");
